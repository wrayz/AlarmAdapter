...
Scenario: Camera發送訊息
	...
	Then EF解析告警結果為
	| DEVICE_SN | DEVICE_ID | TARGET_NAME | TARGET_VALUE               | TARGET_MESSAGE             | RECEIVE_TIME        | IS_EXCEPTION |
	| 2018003   | ::1       | EVENT_TYPE  | Camera tampering detection | Camera tampering detection | 2018/09/13 13:21:30 | Y            |
	When 執行EF通知檢查作業
	Then EF通知檢查結果為
	| DEVICE_SN | DEVICE_ID | TARGET_NAME | TARGET_VALUE               | TARGET_MESSAGE             | RECEIVE_TIME        | IS_EXCEPTION | IS_NOTIFICATION |
	| 2018003   | ::1       | EVENT_TYPE  | Camera tampering detection | Camera tampering detection | 2018/09/13 13:21:30 | Y            | Y               |
